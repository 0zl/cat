package net.spider.avatar
{
   ...
   public class CombatMC extends MovieClip
   {
      ...
      {
         var child:DisplayObject = null;
         var pLoaderD:ApplicationDomain = null;
         var AssetClass:Class = null;
         child = null;
         var strSkinLinkage:String = param1;
         pLoaderD = param2;
      ...
      public function endAction() : void
      {
         ...
         if(!this.checkQueue())
         {
            ...
            else if(_loc1_ == null || _loc1_ != null && (_loc1_.currentLabel == "Die" || _loc1_.currentLabel == "Feign" || _loc1_.currentLabel == "Dead" || main.Game.world.myAvatar.pMC.pAV.target.npcType == "player" && (!("pvpTeam" in main.Game.world.myAvatar.pMC.pAV.dataLeaf) || main.Game.world.myAvatar.pMC.pAV.dataLeaf.pvpTeam == main.Game.world.myAvatar.pMC.pAV.target.dataLeaf.pvpTeam)))
            {
      ...
      private function randomNumber(param1:Number, param2:Number) : Number
      {
         ...
         return this.randNum < param2 ? Number(Number(this.randNum)) : Number(Number(param2));
      }
