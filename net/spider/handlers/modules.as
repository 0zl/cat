package net.spider.handlers
{
   ...
   public class modules extends MovieClip
   {
      ...
      public static function onMaintainFrame(e:Event) : void
      {
         ...
         var book:MovieClip = null;
         var invBackdrop:* = undefined;
         var invSearchMC:invSearch = null;
         var frame:MovieClip = null;
         var bank:MovieClip = null;
         var inv:MovieClip = null;
      ...
      public static function drawMergePanel() : void
      {
         ...
         var t_scrollMC:MovieClip = null;
         var maskMC:Shape = null;
         var scrollMC:mergeScroll = null;
         var t2_mc:MovieClip = null;
      ...
      {
         var mcFocus:MovieClip = null;
         var mcTarget:String = null;
         var mcUI:MovieClip = null;
         var btGenderMC:* = undefined;
         var btSetMountMC:* = undefined;
         var tryMeMC:* = undefined;
         var t_showBt:* = undefined;
         ...
         if(!(mcTarget == "None" || !mcUI) && !f_itemsDrawn)
         {
            ...
            else if(mcFocus.getChildByName("btGender"))
            {
            ...
            else if(mcFocus.getChildByName("btSetMount"))
            {
            ...
            else if(mcFocus.getChildByName("tryMe"))
            {
            ...
            if(isShowable())
            {
               ...
               else if(mcFocus.getChildByName("showBt"))
               {
