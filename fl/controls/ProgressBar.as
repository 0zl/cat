package fl.controls
{
   ...
   public class ProgressBar extends UIComponent
   {
      ...
      {
         return _maximum <= _minimum || _value <= _minimum ? Number(0) : Number(Math.max(0,Math.min(100,(_value - _minimum) / (_maximum - _minimum) * 100)));
      }
      ...
      protected function drawDeterminateBar() : void
      {
         ...
         determinateBar.x = _direction == ProgressBarDirection.LEFT ? Number(width - _loc2_ - determinateBar.width) : Number(_loc2_);
      }
